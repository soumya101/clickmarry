...
class Home extends CI_Controller {
	...
	public function index()
	{
        ...
        {
            $page_data['get_profile_percentage'] = $this->Crud_model->get_profile_percentage($this->session->userdata['member_id']);
        ...
        {    
            $page_data['get_profile_percentage'] = "" ;
            ...
            $page_data['premium_members'] = array_merge($page_male_profile, $page_female_profile);
            // print_r($page_data['premium_members']);exit;
        }       
        // print_r($get_profile_percentage);exit;
	...
	function listing($para1="",$para2="",$para3="")
	{  
        // print_r($para3);
		if ($para1=="" || $para1=="all") {
            // echo("dd");
            ...
            if($login_state == 'yes'){
                ...
                // print_r($partner_expectation_data[0]['prefered_state']);
                ...
                if(isset($partner_expectation_data[0]['partner_caste'][0])){
                    $page_data['home_caste'] = $partner_expectation_data[0]['partner_caste'];
                    }else{
                        $page_data['home_caste'] ="";    
                }    

                // search by country //
                if(isset($partner_expectation_data[0]['prefered_country'][0])){
                    $page_data['home_country'] = $partner_expectation_data[0]['prefered_country'];
                    }else{
                        $page_data['home_country'] ="";    
                }  
                if(isset($partner_expectation_data[0]['prefered_state'][0])){
                    $page_data['home_state'] = $partner_expectation_data[0]['prefered_state'];
                //    print_r($page_data['home_state']);
                    }else{
                        $page_data['home_state'] ="";    
                }  
        ...
        elseif ($para1=="home_search") {
            ...
            $page_data['marital_status']="";           
            $page_data['search_member_type'] = "all";
            // print_r( $page_data['home_language']);
            recache();
            $this->load->view('front/index', $page_data);
        }
    ...
    // for dashboard mod.dt:09/07/2020 //
   
    function dashboard($para1="",$para2="")
    {
        // print_r($para1);exit;
        ...
        if($login_state == 'yes'){
            ...
            $partner_expectation = $this->Crud_model->get_type_name_by_id('member', $this->session->userdata('member_id'), 'partner_expectation');
            $partner_expectation_data = json_decode($partner_expectation, true);
            // print_r($partner_expectation_data);echo '<br>';
            $get_member_gender = $this->db->get_where('member',array('member_id'=>$this->session->userdata['member_id']))->row()->gender;
           ...
           if (!empty($ignored_ids)) {
            ...
            $countryss = $partner_expectation_data[0]['prefered_country'];            
            $country = $countryss[0] != 0 ? $countryss:'';
            // print_r($country);echo'<br>';
            if (isset($country) && $country != "") {  
                if ($country !=0) {              
                    foreach($country as $value) {
                        $this->db->select('member_id')->like('present_address','"country":"'.$value.'"','both');
            ...
            // print_r($by_country);echo'<br>';
            $statess = $partner_expectation_data[0]['prefered_state'];
            // print_r($state);echo'<br>';exit;
            $state = $statess[0] != 0 ? $statess:'';
            if (isset($state) && $state != "") {
               
                if ($state !=0) {
                    // print_r("hjh");exit;
                    foreach($state as $value) {
                        $this->db->select('member_id')->like('present_address','"state":"'.$value.'"','both');
                        $by_states = $this->db->get('member')->result();
                        foreach ($by_states as $by_statess) {
                            $by_state[] = $by_statess->member_id;
                        }
                    }
            ...
            // exit;
            $religion = $partner_expectation_data[0]['partner_religion'];
            if (isset($religion) && $religion != "") {
                foreach($religion as $value) {
                    $this->db->select('member_id')->like('spiritual_and_social_background','"religion":"'.$value.'"','both');
            ...
            $aged_from = $partner_expectation_data[0]['partner_age_from'];
            if (!empty($aged_from)) {
            ...
            $aged_to = $partner_expectation_data[0]['partner_age_to'];
            if (!empty($aged_to)) {
            ...
            $min_height = $partner_expectation_data[0]['partner_height_from'];
            $max_height = $partner_expectation_data[0]['partner_height_to'];
            ...
            $marital_status = $partner_expectation_data[0]['partner_marital_status'];
            if (isset($marital_status) && $marital_status != "") {
                foreach($marital_status as $value) {
                    $this->db->select('member_id')->like('basic_info','"marital_status":"'.$value.'"','both');
            ...
            $caste = $partner_expectation_data[0]['partner_caste'];
            if (isset($caste) && $caste != "") {
                foreach($caste as $value) {
                    $this->db->select('member_id')->like('spiritual_and_social_background','"caste":"'.$value.'"','both');
            ...
            $sub_caste = $partner_expectation_data[0]['partner_sub_caste'];
            // print_r($sub_caste);exit;
            if (isset($sub_caste) && $sub_caste != ""){
                foreach($sub_caste as $value){                    
                    $this->db->select('member_id')->like('spiritual_and_social_background','"sub_caste":"'.$value.'"','both');
                    $by_sub_caste2 = $this->db->get('member')->result();  
                    
                    foreach ($by_sub_caste2 as $by_sub_caste1){
                        $by_sub_caste[] = $by_sub_caste1->member_id;
                    }
                    // print_r($by_sub_caste);echo'<br>';
                }
                
            }else{
                $by_sub_caste = $all_result;
            }
            // print_r($by_sub_caste);exit;
            $languagess = $partner_expectation_data[0]['partner_mother_tongue'];
            $language = $languagess[0] != 0 ? $languagess:'';
            ...
            $manglik = $partner_expectation_data[0]['manglik'];
            ...
            // print_r($by_manglik);exit;
            $education = $partner_expectation_data[0]['partner_education'];
            ...
            if (isset($education) && $education != "") {  
                ...
                // print_r($by_education); echo '<br>';  
            } else {
                $by_education = $all_result;
            }
            // print_r($by_education);exit;
            $profession = $partner_expectation_data[0]['partner_profession'];
            ...
            $disability = $partner_expectation_data[0]['partner_any_disability'];
            if (isset($disability) && $disability != "") {               
                foreach($disability as $value) {
                        $this->db->select('member_id')->like('physical_attributes','"any_disability":"'.$value.'"','both');
                        $by_disabilitys = $this->db->get('member')->result();
                        foreach ($by_disabilitys as $by_disabilitys) {
                            $by_disability[] = $by_disabilitys->member_id;
                        }
                    }
            } else {
                $by_disability = $all_result;
            }
            $body_type = $partner_expectation_data[0]['partner_body_type'];
            // $language = $languagess[0] != 0 ? $languagess:'';
            // print($body_type);
            if (isset($body_type) && $body_type != "") {  
                // print($body_type); 
                foreach($body_type as $value) {
                    $this->db->select('member_id')->like('physical_attributes','"body_type":"'.$value.'"','both');
                    $by_body_types = $this->db->get('member')->result();
                    foreach ($by_body_types as $by_body_types) {
                        $by_body_type[] = $by_body_types->member_id;
                    }
                }
            } else {
                $by_body_type = $all_result;
            }
        ...
        //    print_r($by_disability);
            $all_array = array_intersect($by_gender,$by_profession,$by_manglik,$by_height,$by_age,$by_country,$by_state,$by_marital_status,$by_language,$by_religion,$by_caste,$by_disability);
            // print_r($all_array);exit;
            if (count($all_array) != 0) {
                $this->db->where_in('member_id', $all_array);
                $cond = array('is_blocked' =>'no','is_closed' =>'no');
                $page_data['get_all_members'] = $this->db->order_by("last_logined", "desc")->where($cond)->get('member')->result();
            } else {
                $page_data['get_all_members']  = array();
            }

            $recent_view_list = json_decode($this->Crud_model->get_type_name_by_id('member', $this->session->userdata('member_id'), 'recent_view'), true);
            if (count($recent_view_list) != 0) {
                // $this->db->order_by('member_id',"DESC");
                $this->db->where_in('member_id', $recent_view_list);
                $cond = array('is_blocked' =>'no','is_closed' =>'no');
                $page_data['recent_view_list'] = $this->db->where($cond)->get('member')->result();
                // echo $this->db->last_query();exit;
            } else {
                $page_data['recent_view_list']  = array();
            }
            ...
            foreach ($total_interests as $total_interest) {
                // print_r($total_interest['status']);
                if($total_interest['status']!="rejected"){
                    array_push($total_interests_ids ,$total_interest['id']);
                }
                // array_push($total_interests_ids ,$total_interest['id']);
            }
            if (count($total_interests) != 0) {
                // print_r($total_interests_ids);
                $page_data['express_interest_members'] = $this->db->from('member')->where_in('member_id', $total_interests_ids)->get()->result();
                // echo $this->db->last_query();
                $page_data['array_total_interests'] = $total_interests;
            } else {
                $page_data['express_interest_members']  = array();
            }
            // print_r($page_data['express_interest_members']);
        }  
        if ($para1 != "" || $para1 != NULL) {
            ...
            if ($para1 == $member_id) {
                $page_data['title'] = "Dashboard || ".$this->system_title;
                ...
                // print($page_data['get_all_members']);
                if(empty($page_data['get_all_members']) && empty($page_data['recent_view_list']) && empty($page_data['express_interest_members'])) {
                    // $this->load->view('front/index', $page_data);
    ...
    //end of dashboard //
//print member profile mod:dt:29/07/2020 //

function print_member_profile($member_id = "") {
    if ($this->member_permission() == FALSE) {
        redirect(base_url().'home/login', 'refresh');
    }
    $login_state = $this->session->userdata('login_state');
    if($login_state == 'yes'){
        ...
        $this->load->view('front/member_profile/member_profile_print', $page_data);
    }
}

// enfd of profile print //
    ...
    function member_profile($para1="",$para2="")
    {
        ...
        if ($para1 != "" || $para1 != NULL) {
            ...
            if (!in_array($para1, $ignored_ids) && $para1 != $member_id) {
                ...
                //update recent view profile //
                $recent_viewed = $this->Crud_model->get_type_name_by_id('member', $member_id, 'recent_view');
                $recent_viewed_members = json_decode($recent_viewed, true);

                if (empty($recent_viewed_members)) {                
                    $recent_viewed_members = array();
                    array_push($recent_viewed_members, $para1);
                }   
                if (!in_array($para1, $recent_viewed_members)) {
                    array_push($recent_viewed_members, $para1);
                }        
                
                $this->db->where('member_id', $member_id);
                $this->db->update('member', array('recent_view' => json_encode(array_reverse($recent_viewed_members))));
                // end of recent view profile // 
    ...
    //    echo($para2);
        ...
        elseif ($para2 == "search") {
            ...
            // print_r($this->input->post('with_photo'));
            if (!empty($aged_from)) {
                $aged_from=$this->Crud_model->get_type_name_by_id('preference_decision', $aged_from);
                ...
                $sql_aged_from = strtotime(date('Y-m-d', strtotime("-".$aged_from." years")));
                //$sql_aged_from = strtotime("-".$aged_from." years");
        ...
        //    print_r($member_profile_id);
            if (isset($member_profile_id) && $member_profile_id != "") {
                ...
                $user_search_member_gender = $this->db->select('*')->get_where('member', array('member_profile_id' => $member_profile_id))->result();                   
                foreach ($user_search_member_gender as $user_search_member_genders) {
                    $search_member_gender['gender'] = $user_search_member_genders->gender;                   
                }           
                // echo('naresh'.$search_member_gender); 
                if(!empty($search_member_gender)){
                   
                    if ($search_member_gender['gender'] ==  $get_member_gender) {
                        $page_data['search_gender'] = $search_member_gender['gender'];
                        $page_data['login_gender'] =  $get_member_gender;
                        echo '<div class="" align="center" style="color:red"><i class="fa fa-exclamation-triangle sm"></i> '.'Sorry ! You can’t view the profile of same gender'.'</div>';
           ...
           if (isset($marital_status) && $marital_status != "") {
            ...
            foreach($sun_sign as $value) {
                $this->db->select('member_id')->like('astronomic_information','"sun_sign":"'.$value.'"','both');
            ...
            if (isset($with_photo) && $with_photo !="") {
                ...
                if($with_photo=='Yes'){
                    ...
                    $this->db->not_like('profile_image','"profile_image":"female.png"');
                    $this->db->not_like('profile_image','"profile_image":"male.png"');
                }else{
                    // $this->db->select('member_id')->like('profile_image','"profile_image":"default.jpg"','both');
                    $this->db->select('member_id');
                    $this->db->or_like('profile_image','"profile_image":"default.jpg"');
                    $this->db->or_like('profile_image','"profile_image":"female.png"');
                    $this->db->or_like('profile_image','"profile_image":"male.png"');    
                }
                $by_with_photos = $this->db->get('member')->result();
                // echo $this->db->last_query();
                // print_r($by_with_photos);
                foreach ($by_with_photos as $by_with_photos) {
                    // print_r($by_with_photos);
                    // $bywithphoto_array = json_decode($by_with_photos->profile_image, true);
                    // foreach($bywithphoto_array as $key => $row){
                    //     if($row['profile_image']!='default.jpg' ){
                    //         if($row['profile_image']!='female.png' ){
                    //             if($row['profile_image']!='male.png' ){
                    //                 // print_r($row['profile_image']);echo'<br>';
    ...
    function view_contact($member_id){
        ...
        $view_text="<div class='row'><div class='col-md-4 col-4 text-right font-dark'>Profile</div><div class='col-md-8 col-8 text-left'><strong class='c-base-1'>" .$profile_fname." ".$profile_lname. " [ ".$profile_id." ]</strong></div></div>";
        $view_text=$view_text."<div class='row'><div class='col-md-4 col-4 font-dark text-right'>Primery Mobile:</div><div class='col-md-8 col-8 font-dark text-left'>".$primary_contact."</div></div>"; 
        $view_text=$view_text."<div class='row'><div class='col-md-4 col-4 font-dark text-right'>Alternet Mobile:</div><div class='col-md-8 col-8 font-dark text-left'> ".$personal_attitude_and_behavior_data[0]['religious_service']."</div></div>";
        $view_text=$view_text."<div class='row'><div class='col-md-4 col-4 font-dark text-right'>Contact Person: </div><div class='col-md-8 col-8 font-dark text-left'>".$this->Crud_model->get_type_name_by_id('whom_contact', $personal_attitude_and_behavior_data[0]['affection'])."</div></div>"; 
        $view_text=$view_text."<div class='row'><div class='col-md-4 col-4 font-dark text-right'>Name: </div><div class='col-md-8 col-8 font-dark text-left'>".$personal_attitude_and_behavior_data[0]['humor']."</div></div>";
        $view_text=$view_text."<div class='row'><div class='col-md-4 col-4 font-dark text-right'>Time: </div><div class='col-md-8 col-8 font-dark text-left'>".$personal_attitude_and_behavior_data[0]['political_view']."</div></div>"; 
        echo($view_text);
    }
    ...
    function add_interest($member_id)
    {
        ...
        if ($express_interest > 0) {
            ...
            // echo $member_id.' '. $member;
            $this->express_intrest_mail_send($member_id,$member);
        }
    }
    ...
    {
        // print_r($this->session->userdata('member_id'));exit;
        if ($this->member_permission() == FALSE) {
            redirect(base_url().'home/login', 'refresh');
        }
        ...
        $this->Sms_model->send_sms_via_sms7($message, $receiver_mobile);
        $this->accept_mail_send($member_id,$member);
        recache();
    }
    ...
    function reject_interest($member_id)
    {
        ...
        if (!empty($interest)) {
            foreach ($interest as $value3) {
                ...
                elseif ($value3['id'] == $member) {
                    array_push($new_interest, array('id'=>$value3['id'], 'status'=>'Decline', 'time'=>time()));
                }
                // print_r($new_interest)."<br>";
            }
        }
    ...
    function add_follow($member_id)
    {
        ...
        $followers = $this->Crud_model->get_type_name_by_id('member', $member_id, 'following_member');
        $following_members = json_decode($followers, true);
        ...
        // Following members //
        if (empty($following_members)) {                
            $following_members = array();
            array_push($following_members, $member);
        }   
        if (!in_array($member, $following_members)) {
            array_push($following_members, $member);
        }        
        
        $this->db->where('member_id', $member_id);
        $this->db->update('member', array('following_member' => json_encode($following_members)));
        // End of Following members //

        // print_r($following_members);exit;
        $this->db->where('member_id', $member);
    ...
    function add_unfollow($member_id)
    {
        ...
        // Unfollow following member // 
        if (empty($following_members)) {
            $following_members = array();
        }
       
        $new_following_array = array();
        foreach ($following_members as $value) {
            if ($value != $member) {
                array_push($new_following_array, $value);
            }
        }
        $following_members = $new_following_array;

        $this->db->where('member_id', $member_id);
        $this->db->update('member', array('following_member' => json_encode($following_members)));
        // End of unfollow following member //
    ...
    function add_report($member_id)
    {
        ...
        $this->Email_model->profile_report($from,$from_name,$reported_person,$member);
        recache();
    }
	...
	{       
        ...
        elseif ($para1=="contact_list") {
			$this->load->view('front/profile/contact_list/index');
        }
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                echo json_encode($ajax_error);
                    ...
                    $partner_expectation[] = array('general_requirement'	=>  $this->input->post('general_requirement'),
                                        ...
                                        'partner_family_value'				=>	$this->input->post('partner_family_value'),
                                        'prefered_country'					=>	$this->input->post('prefered_country'),
                                        'prefered_state'					=>	$this->input->post('prefered_state') != '' ? !is_array($this->input->post('prefered_state')) ? array($this->input->post('prefered_state'))  : $this->input->post('prefered_state') : '0',
                                        'prefered_status'					=>	$this->input->post('prefered_status'),
                                        'prefered_status1'					=>	$this->input->post('prefered_status1')
                                        );
                    $data['partner_expectation'] = json_encode($partner_expectation);
                    // print_r($partner_expectation);exit;
                    $this->db->where('member_id', $this->session->userdata('member_id'));
                    $result = $this->db->update('member', $data);
    ...
    function delete_profile_img(){
        ...
        $gender = $this->Crud_model->get_type_name_by_id('member', $member_id, 'gender');
        
        $profile_image[] = array('profile_image'    =>  $gender != 1 ? 'female.png' : 'male.png',
                                    'thumb'         =>  $gender != 1 ? 'female_thumb.png' : 'male_thumb.png');
    ...
    function ajax_my_interest_list($para1="",$para2="")
    {
        ...
        foreach ($total_interests as $total_interest) {
            array_push($total_interests_ids ,$total_interest['id']);
            array_push($interest_date,$total_interest['time']);
            // print_r($interest_date);            
        }
    ...
    function ajax_my_contacts_list($para1="",$para2="")
    {
        $this->load->library('Ajax_pagination');

        $total_contacts = json_decode($this->Crud_model->get_type_name_by_id('member', $this->session->userdata('member_id'), 'view_contacts'), true);
        $config['total_rows'] = count($total_contacts);

        // pagination
        $config['base_url'] = base_url().'home/ajax_my_contacts_list/';
        $config['per_page'] = 10;
        $config['uri_segment'] = 5;
        $config['cur_page_giv'] = $para1;
        ...
        $config['num_tag_close'] = '</a></li>';
        $this->ajax_pagination->initialize($config);
        $total_contacts_ids = array();
        foreach ($total_contacts as $total_contact) {
            array_push($total_contacts_ids ,$total_contact['id']);
        }
        if (count($total_contacts) != 0) {
            $page_data['contacted_members'] = $this->db->from('member')->order_by('member_id',"DESC")->where_in('member_id', $total_contacts_ids)->limit($config['per_page'], $para1)->get()->result();
            $page_data['array_total_contacts'] = $total_contacts;
            // print_r($page_data['contacted_members']);
        }
        else{
            $page_data['contacted_members'] = NULL;
        }
        $page_data['count'] = $config['total_rows'];


        $this->load->view('front/profile/contact_list/ajax_contacts', $page_data);
    }
    ...
    function ajax_short_list($para1="",$para2="")
    {
        ...
        if (count($total_shortlist) != 0) {
            ...
            // $page_data['express_shortlist_members'] = $this->db->from('member')->order_by('member_id','DESC')->where_in('member_id', $total_shortlist)->limit($config['per_page'], $para1)->get()->result();
        }
        else{
                ...
                if ($safe == 'yes') {
                    ...
                    if ($this->Crud_model->get_settings_value('third_party_settings', 'captcha_status', 'value') == 'ok') {
                        ...
                        if ($response['success']) {
                            ...
                            // $this->Email_model->contactUs_mail_send($data['email'],$data['name'],$data['subject'],$data['message']);
                            echo 'sent';
                        } else {
                            $page_data['title'] = "Contact Us || ".$this->system_title;
                            $page_data['top'] = "contact_us.php";
	          ...
	          //  $this->form_validation->set_rules('mobile', 'Mobile Number', 'required');
	            ...
	            if ($this->form_validation->run() == FALSE) {
	            	...
	            	if ($safe == 'yes') {
                        ...
                        //                             'thumb'         =>  'default_thumb.jpg'
                        //                     );
                        $profile_image[] = array('profile_image'    =>  $this->input->post('gender') != 1 ? 'female.png' : 'male.png',
                                                    'thumb'         =>  $this->input->post('gender') != 1 ? 'female_thumb.png' : 'male_thumb.png'
                                    );
                        ...
                        //    echo("regis");exit;
                            ...
                            $this->session->set_userdata($data1);
                            $message="www.clickmarry.in \n Your mobile verification code : ".$this->session->userdata('member_otp');
                            //echo($this->session->userdata('member_otp'));
    ...
    function validate_otp(){
        if($this->session->userdata('member_otp')==$this->input->post('otp_entered')){
            ...
            // redirect sucessfull login mod:dt:4/08/2020 //
           
            $data['login_state'] = 'yes';
            $data['member_id'] = $this->session->userdata('otp_member_id');
            $data['member_name'] = $first_name;
            $data['member_email'] = $this->Crud_model->get_type_name_by_id('member', $this->session->userdata('otp_member_id'), 'email');
            $expaired= $this->Crud_model->check_package_expairy($this->session->userdata('otp_member_id'));
            if($expaired=='Yes'){
                $data['membership']=1;
                print "<script type=\"text/javascript\">alert('Your Package has expaired!');</script>";                              
            }else{
                $data['membership'] = $this->Crud_model->get_type_name_by_id('member', $this->session->userdata('otp_member_id'), 'email');
            }
            
            $this->Crud_model->update_last_login($this->session->userdata('otp_member_id'));
    ...
    function get_advance_filteration_by_id_country_array($table,$field,$id="",$caste="")
    {
        $id=$this->input->post('ids');
        $this->db->where_in($field,$id);
        $options = $this->db->get($table)->result_array();
