	                                    ...
	                                    <div class="form-group has-feedback">
	                                        ...
	                                        <?php
	                                            if (!empty($form_contents)) {
	                                                ...
	                                                echo $this->Crud_model->select_html('on_behalf', 'on_behalf', 'name', 'edit', 'form-control form-control-sm selectpicker', (!empty($basic_info[0]['on_behalf']) ? $basic_info[0]['on_behalf'] : '' ), '', '', '');
	                                            }
	                                        ?>
	                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
	                                        <div class="help-block with-errors">
	                                    ...
	                                    <div class="form-group has-feedback">
	                                        ...
	                                        <?php
	                                            if (!empty($form_contents)) {
	                                                ...
	                                                echo $this->Crud_model->select_html('family_status', 'family_status', 'name', 'edit', 'form-control form-control-sm selectpicker present_family_status_f_edit', (!empty($spiritual_and_social_background[0]['family_status']) ? $spiritual_and_social_background[0]['family_status'] :''), '', '', '');
	                                            }
	                                        ?>
	                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
	                                        <div class="help-block with-errors">
