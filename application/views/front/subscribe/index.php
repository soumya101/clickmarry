                    ...
                    <div class="feature feature--boxed-border feature--bg-2 active package_bg mt-4">
                        <div class="icon-block--style-1-v5 text-center">
                            ...
                            <div class="block-content">
                                ...
                                <?php if($no_contact !="") { ?>
                                <h3 class="price-tag"><sup style="font-size: 36px;"></sup><?=currency(($value->amount)*($no_contact)+10)?></h3>
                                <?php }else { ?>
                                <h3 class="price-tag"><sup style="font-size: 36px;"></sup><?=currency($value->amount)?></h3>  
                                    <ul class="pl-0 pr-0 mt-0">
                                        ...
                                        <li class="<?=$package_class?> package_items"><?php echo translate('express_interest:')?> <?=$value->express_interest?> <?php echo translate('IDs')?></li>
                ...
                <?php }else{ ?>
                    ...
                    <div class="row pb-4">
                        <div class="col-sm-12 ml-auto mr-auto">
                            ...
                            <div class="row justify-content-md-center" id="payment_section">
                                <style>
                                    .span-text {
                                        font-weight: 500;
                            ...
                            <div class="text-center pt-3">
                                ...
                                <input type="hidden" name="<?= $hash_name;?>" value="<?= $hash_value;?>">
                                    ...
                                    <input type="hidden" name="no_contact" value="<?=$no_contact?>">
                                    <?php
                                        $exchange = exchange('usd');
                                        if($no_contact==""){
                                            $stripe_amount= $value->amount/$exchange;
                                        }else{
                                            $stripe_amount= ($value->amount/$exchange*($no_contact)+10);   
                                        }
                                    ?>
