                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="text-uppercase font_light"><?php echo translate('email')?> / Mobile / Profile ID</label>
                                                <input type="text" class="form-control input-sm" name="email" autofocus required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
