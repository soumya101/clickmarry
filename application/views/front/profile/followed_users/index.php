<div class="card-title">
    ...
    <b><?php echo translate('Super_like')?></b></h3>
</div>
        ...
        <?php 
            ...
            if ($new_followed_members_data) { ?>
                ...
                <?php
                    ...
                    ?>
                    <li><img src="<?=base_url()?>uploads/profile_image/<?=$image[0]['thumb']?>"><a href="<?=base_url()?>home/member_profile/<?=$member_id?>" style="color: #55595c"><p class="c-base-1"><?=$member_name?></p></a></li>
                    <?php
                    }
                    else {
                    ?>
                    <li><img src="<?=base_url()?>uploads/profile_image/default_image.png"><a href="<?=base_url()?>home/member_profile/<?=$member_id?>" style="color: #55595c"><p class="c-base-1"><?=$member_name?></p></a></li>
                <?php
                }
                ?>            
            <?php }?>
