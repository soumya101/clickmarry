    ...
    <table class="table table-sm table-striped table-hover table-bordered table-responsive" id="example">
        <thead>
        <tr>
            <th>
        ...
        <?php
            ...
            foreach ($new_express_interest_members as $data): ?>
                ...
                <tr id="member_<?=$member_id?>">
                        ...
                        <?php
                            foreach ($array_total_interests as $total_interest) {
                                if ($total_interest['id'] == $member_id) {
                                    ...
                                    <?php
                                    } elseif ($total_interest['status'] == 'Decline') {
                                    ?>
                    ...
                    <td  data-order="<?= $array_total_interests['time'] ?>" >
                        <p>
                            <?php
                                foreach ($array_total_interests as $intrest_date_time) {
                                    if ($intrest_date_time['id'] == $member_id) {
                                        echo (date('d/m/Y H:i:s', $intrest_date_time['time']));
                                    }
                                }
                            ?>        
                        </p>
