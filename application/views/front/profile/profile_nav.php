        ...
        <div class="container navbar-container">
            ...
            <div class="collapse navbar-collapse justify-content-between align-items-center" id="navbar_main">
                <ul class="navbar-nav " data-hover="dropdown" data-animations="zoomIn zoomIn zoomIn zoomIn">
                    ...
                    <li class="nav-item">
                        <a class="nav-link interests_on_me p_nav" onclick="profile_load('interests_on_me')">
                            <i class="fa fa-heart"></i> <?php echo translate('interests_on_me')?>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link contact_list p_nav" onclick="profile_load('contact_list')">
