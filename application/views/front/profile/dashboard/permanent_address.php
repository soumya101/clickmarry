...
<div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
            ...
            <div class="table-full-width">
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('district')?></span>
                            </td>
                            <td>
    ...
    <div id="edit_permanent_address" style="display: none;">
        <div class="card-inner-title-wrapper pt-0">
            ...
            <div class="pull-right">
                <button type="button" class="btn btn-success btn-sm btn-icon-only btn-shadow" onclick="save_section('permanent_address')"><i class="ion-checkmark" title="Save"></i></button>
                <button type="button" class="btn btn-danger btn-sm btn-icon-only btn-shadow" onclick="load_section('permanent_address')"><i class="ion-close" title="Close"></i></button>
            </div>
        </div>
        ...
        <form id="form_permanent_address" class="form-default" role="form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="permanent_city" class="text-uppercase c-gray-light"><?php echo translate('district')?> *</label>
                        <?php
