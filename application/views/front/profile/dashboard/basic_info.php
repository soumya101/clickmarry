...
<div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
            ...
            <div class="table-full-width">
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <?php if($basic_info_data[0]['number_of_children']!='') { ?> 
                        <tr>
                            <td class="td-label">
                        ...
                        <tr>
                            ...
                            <td class="td-label">
                                <span><?php echo translate('Primary_mobile')?></span>
                            </td>
    ...
    <div id="edit_basic_info" style="display: none;">
        <div class="card-inner-title-wrapper pt-0">
            ...
            <div class="pull-right">
                <button type="button" class="btn btn-success btn-sm btn-icon-only btn-shadow" onclick="save_section('basic_info')"><i class="ion-checkmark" title="Save"></i></button>
                <button type="button" class="btn btn-danger btn-sm btn-icon-only btn-shadow" onclick="load_section('basic_info')"><i class="ion-close" title="Close"></i></button>
            </div>
        </div>
        ...
        <form id="form_basic_info" class="form-default" role="form">
            ...
            <div class="row">
                 <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control no-resize" id="dob" name="date_of_birth" value="<?=date('d-m-Y', $get_member[0]->date_of_birth)?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('marital_status', 'marital_status', 'name', 'edit', 'form-control form-control-sm marital_status', $basic_info_data[0]['marital_status'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <div class="row no_child" style="display:none">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="number_of_children" class="text-uppercase c-gray-light"><?php echo translate('number_of_children')?></label>
                        <input type="number" class="form-control no-resize no_of_child" name="number_of_children" value="<?=$basic_info_data[0]['number_of_children']?>" min="0">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="on_behalf" class="text-uppercase c-gray-light"><?php echo translate('Profile_created_for')?> *</label>
                        <?php
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="mobile" class="text-uppercase c-gray-light"><?php echo translate('Primary_mobile')?> *</label>
                        <input type="hidden" name="old_mobile" value="<?=$get_member[0]->mobile?>">
                        <input type="number" class="form-control no-resize" name="mobile" value="<?=$get_member[0]->mobile?>" readonly>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
...
$(".marital_status").change(function(){
        ...
        if ((marital_status != "") && (marital_status !="1")) {           
            $('.no_child').show();
        } else {
            $(".no_of_child").val('');
            $('.no_child').hide();
