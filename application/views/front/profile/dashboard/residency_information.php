...
<div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
    ...
    <div id="edit_residency_information" style="display: none;">
        <div class="card-inner-title-wrapper pt-0">
            ...
            <div class="pull-right">
                <button type="button" class="btn btn-success btn-sm btn-icon-only btn-shadow" onclick="save_section('residency_information')"><i class="ion-checkmark" title="Save"></i></button>
                <button type="button" class="btn btn-danger btn-sm btn-icon-only btn-shadow" onclick="load_section('residency_information')"><i class="ion-close" title="Close"></i></button>
            </div>
        </div>
