...
<div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
    <div id="info_present_address">
        <div class="card-inner-title-wrapper pt-0">
            ...
            <?=($this->Crud_model->get_type_name_by_id('gender', $get_member[0]->gender)== 'Male' ? "Groom's " :"Bride's ")?><?php echo translate('present_address')?>
            </h3>
    ...
    <div id="edit_present_address" style="display: none">
        ...
        <form id="form_present_address" class="form-default" role="form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="city" class="text-uppercase c-gray-light"><?php echo translate('district')?> *</label>
                        <?php
