        ...
        <div class="profile-connect mt-2">
            <div class="row">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="my_profile_<?=$get_member[0]->member_id?>" href="<?= base_url();?>home/profile" target="_blank">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="my_interest_<?=$get_member[0]->member_id?>" onclick="profile_load('my_interests')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="interests_on_me_<?=$get_member[0]->member_id?>" onclick="profile_load('interests_on_me')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="contact_list_<?=$get_member[0]->member_id?>" onclick="profile_load('contact_list')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="short_list_<?=$get_member[0]->member_id?>" onclick="profile_load('short_list')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="followed_users_<?=$get_member[0]->member_id?>" onclick="profile_load('followed_users')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="messaging_<?=$get_member[0]->member_id?>" onclick="profile_load('messaging')">
                        <span id="interest_text">
                ...
                <div class="col-sm-12 size-sm mb-2">
                    <a class="btn btn-styled btn-block btn-sm btn-white z-depth-2-bottom" id="ignored_list_<?=$get_member[0]->member_id?>" onclick="profile_load('ignored_list')">
                        <span id="interest_text">
