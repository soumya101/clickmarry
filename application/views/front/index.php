...
<!-- Bootstrap Modal  for print profile-->
<div class="modal fade" id="active_print_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="margin-top: 30vh;">
        <div class="modal-content">
            <div class="modal-header text-center mt-3" style="display: block; border-bottom: 1px solid transparent">
                <div class="row">
                    <div class="col-md-7 text-right">
                        <span class="modal-title" id="modal_header_print"><?php echo translate('title')?></span>  
                    </div>
                    <div class="col-md-5 text-right">
                        <a href='#' id='' class='btn btn-danger btn-sm btn-shadow' onclick='window.location.reload();' style='width:25%'><?php echo translate('cancel')?></a> <a href='#' id='' class='btn btn-sm btn-base-1 btn-shadow' onclick='return do_print()' style='width:25%'><?php echo translate('print')?></a>            
                    </div>                    
                </div>
               
            </div>
            <div class="modal-body text-center" id="modal_body_print">
                <!-- <div class='text-center' id='payment_loader'><i class='fa fa-refresh fa-5x fa-spin'></i><p><?php echo translate('please_wait_...')?></p></div> -->
            </div>
            <!-- <div class="text-center" id="modal_buttons_print">
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><?php echo translate('close')?></button>
            </div> -->
        </div>
    </div>
...
<script>
   ...
   function goto_album(id){
         //alert(id);       
        var divcontaint=$('#lightGallery_'+id).html();
        // console.log(divcontaint);
        $('#showgallery').html('');
        $('#showgallery').html(divcontaint);
        
        var $lg = jQuery('div#showgallery'); 
        $lg.lightGallery({
            download:false
        }); 
