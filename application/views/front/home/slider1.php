                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3 col-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <?php 
                                        ...
                                        echo $this->Crud_model->select_html('preference_decision', 'aged_from', 'name', 'edit', 'form-control form-control-sm aged_from', $aged_from, 'custom_field', 'AGE', '');
                                    ?>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3 col-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <?php 
                                        ...
                                        echo $this->Crud_model->select_html('preference_decision', 'aged_to', 'name', 'edit', 'form-control form-control-sm aged_to', $aged_to, 'custom_field', 'AGE', '');
                                    ?>
                                </div>
                                <div class="help-block with-errors">
                                </div>
